...
class MemoryDB:
    ...
    def _init_database(self) -> None:
        ...
        try:
            ...
            cur.execute('CREATE INDEX IF NOT EXISTS idx_messages_type ON messages(message_type)')
            cur.execute('CREATE INDEX IF NOT EXISTS idx_responses_message_id ON responses(message_id)')
    ...
    def store_message(self, content: str, message_type: str = "user", 
    ...
    def store_response(self, message_id: int, content: str, 
                      processing_time: Optional[float] = None) -> Optional[int]:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            cur.execute('SELECT AVG(processing_time) FROM responses WHERE processing_time IS NOT NULL')
    ...
    def cleanup_old_data(self, days: int = 30) -> int:
        ...
        try:
            ...
            print(f"🧹 Cleanup: {deleted_messages} messages, {deleted_responses} responses deleted")
...
if __name__ == "__main__":
    ...
    # Test Message
    msg_id = db.store_message("Test Message für Samsung Galaxy S25!", 
